//! Bootstrapped code asset for `overworld/rules/interaction.fre.ron`.
//!
//! `overworld/rules/interaction.fre.ron` 的 bootstrap 代码资产。
...
pub fn emit(reg: &mut Registry) -> Result<()> {
    reg.emit_ron("overworld/rules/interaction.fre.ron", &asset())?;
    Ok(())
}
