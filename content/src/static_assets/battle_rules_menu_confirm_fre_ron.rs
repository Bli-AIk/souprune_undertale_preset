//! Bootstrapped code asset for `battle/rules/menu_confirm.fre.ron`.
//!
//! `battle/rules/menu_confirm.fre.ron` 的 bootstrap 代码资产。
...
pub fn emit(reg: &mut Registry) -> Result<()> {
    reg.emit_ron("battle/rules/menu_confirm.fre.ron", &asset())?;
    Ok(())
}
